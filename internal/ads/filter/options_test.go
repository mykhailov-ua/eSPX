...
// Guards Redis client timeouts stay aligned with the filter engine deadline on every shard.
...
// Guards exported read timeout milliseconds match filter deadline for verification hooks.
