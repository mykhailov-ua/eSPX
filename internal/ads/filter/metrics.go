...
// FilterEngineFailures counts unexpected filter engine errors on the ingest path.
var FilterEngineFailures = filterEngineFailures

// FilterFraudStreamWriteErrors counts fraud stream write failures on the ingest path.
var FilterFraudStreamWriteErrors = filterFraudStreamWriteErrors
