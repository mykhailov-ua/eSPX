...
// Sharder maps campaign IDs to Redis shard indices.
type Sharder = sharding.Sharder
...
// SetBytes assigns the wrapped slice for Redis stream marshaling.
func (v *ByteSliceValue) SetBytes(b []byte) {
	v.b = b
}
