...
// TestChaos_ShardLoadSpike automates SHARDING_STRATEGY §7.3 sharp load rise on a pinned control cohort.
// CI: 32 concurrent gnet workers × 200 impressions (R5). Sustained 30 s 10× ramp: scripts/load/k6_spike_traffic.js.
