...
func TestMLModelSync_EndToEnd(t *testing.T) {
	if testing.Short() {
	...
	orchestrator := NewMLModelSyncOrchestrator(svc)
...
func TestMLModelSync_CanaryRollback(t *testing.T) {
	if testing.Short() {
		t.Skip("skipping integration test in short mode")
	}
...
func TestMLModelSync_StaleEpochTighten(t *testing.T) {
	if testing.Short() {
		t.Skip("skipping integration test in short mode")
	}
