...
if grep -rnEi "\bsyn_flood\b|\budp_flood\b|\bhack_back\b|\breverse_ddos\b" . --exclude-dir="scripts" --exclude-dir="node_modules" --exclude="GUIDE_COMPLIANCE.md" --exclude="MILESTONE.md" 2>/dev/null; then
...
if grep -rnEi "\bnmap\b|\bportscan\b|\bport_scan\b|\bactive_probe\b" . --exclude-dir="scripts" --exclude-dir="node_modules" --exclude="GUIDE_COMPLIANCE.md" --exclude="MILESTONE.md" 2>/dev/null; then
