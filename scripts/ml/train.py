...
def main():
    ...
    os.makedirs("var/ml/artifacts", exist_ok=True)
    ...
    if HAS_LIBS:
        try:
            ...
            model_txt_path = "var/ml/artifacts/model.txt"
            ...
            onnx_path = "var/ml/artifacts/iforest.onnx"
            ...
            with open("var/ml/artifacts/metadata.json", "w") as f:
                json.dump(metadata, f, indent=4)
                
            print("Training complete. Artifacts written to var/ml/artifacts/")
    ...
    src_model = "internal/mlanalytics/testdata/model.txt"
    dest_model = "var/ml/artifacts/model.txt"
    ...
    dest_onnx = "var/ml/artifacts/iforest.onnx"
    ...
    print("Fallback artifacts written to var/ml/artifacts/")
    print(f"Model version: {metadata['version']}")
