-- Local EXPLAIN probe for reconciliation window aggregation on balance_ledger.
-- Run after index or partition changes; recon lag directly affects billing accuracy.
