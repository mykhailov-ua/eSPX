...
local crc32c_table = {
    ...
    0x9A879FA0, 0x68EC1CA3, 0x7BBCEF57, 0x89D76C54, 0x5D1D08BF, 0xAF768BBC, 0xBC263848, 0x4E4DBB4B,
    0x20BD8EDE, 0xD2D60DDD, 0xC186FE29, 0x33ED7D2A, 0xE72719C1, 0x154C9AC2, 0x061C6936, 0xF477EA35,
    0xAA64D611, 0x580F5512, 0x4B5FA6E6, 0xB93425E5, 0x6DFE410E, 0x9F95C20D, 0x8CC531F9, 0x7EAEB2FA,
    0x30E349B1, 0xC288CAD2, 0xD1D83946, 0x23B3BA45, 0xF779DEAE, 0x05125DAD, 0x1642AE59, 0xE4292D5A,
...
local function crc32c_bytes(data)
...
function _M.get_shard(campaign_id)
    ...
    local slot = bit.band(crc32c_bytes(raw), 1023)
    local shard = dict:get("s:" .. slot)
    return shard
end
...
function _M.sync()
    ...
    if not doc.slots or type(doc.slots) ~= "table" or #doc.slots ~= 1024 then
